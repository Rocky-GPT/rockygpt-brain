...
def tool_definitions() -> list[dict[str, Any]]:
    return [
        ...
        function_tool(
            ...
            "subject and graduation_plans sections. Prefer it for named "
            "combined requests, "
            ...
            "Use graduation_plans for an undergraduate program's recommended graduation "
            "(four-year) plans. They are published per admission cohort: cohort selects one, "
            "null returns the newest, and available_cohorts lists the rest. 4+1 and other "
            "variants arrive as summaries; set plan for one, in the first lookup when the "
            "student names it. Name a narrowed_by program. "
            "An unpublished cohort returns citable summaries of the published ones. "
