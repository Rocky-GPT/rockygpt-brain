...
def tool_definitions() -> list[dict[str, Any]]:
    return [
        ...
        function_tool(
            ...
            "campus/dining hours, menu, club and event sections. Prefer it for named combined "
            "requests, "
            ...
            "Choose only requested components. Use club for an organization directory profile "
            "and contact for its published email/links; category determines whether a directory "
            "entry is a student organization. Use event for a specific dated event instance; "
            ...
            "An organized_by relationship returns an explicitly identified club ID; retrieve "
            "its contact or club section for a follow-up. A club's event section traverses "
            "only approved organizer links, retains each occurrence's identity, and reports "
