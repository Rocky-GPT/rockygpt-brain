...
def tool_definitions() -> list[dict[str, Any]]:
    return [
        ...
        function_tool(
            ...
            "null returns the newest, and available_cohorts lists the rest. Say which cohort "
            "a plan is for; another cohort's plan does not apply. 4+1 variants are separate "
            "plans. A plan suggests a sequence; it is not a requirement or prerequisite rule. "
